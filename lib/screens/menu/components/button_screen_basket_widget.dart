...
import 'package:pokemon_collector/screens/basket/basket_screen.dart';

class ButtonScreenBasketWidget extends ConsumerStatefulWidget {
  final bool isRightMove;

  const ButtonScreenBasketWidget({Key? key, this.isRightMove = false}) : super(key: key);

  @override
  ConsumerState<ButtonScreenBasketWidget> createState() => _ButtonScreensWidgetState();
}

class _ButtonScreensWidgetState extends ConsumerState<ButtonScreenBasketWidget> with SingleTickerProviderStateMixin {
        ...
        child: DecoratedBox(
          ...
          child: MaterialButton(
            onPressed: () async {
              ...
              await ref.read(loadBasketProvider.notifier).loadBasket();
